...
<div class="page-heading header-text" style="background-image: url(assets/uploads/<?php echo $banner_checkout; ?>);">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2><?php echo LANG_VALUE_22; ?></h2>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
				                <div style="color:red;font-size:18px;margin-bottom:50px;">
