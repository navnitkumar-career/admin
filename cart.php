...
<!-- <div class="page-heading header-text" style="background-image: url(assets/uploads/<?php echo $banner_cart; ?>);"> -->
<div class="page-heading header-text" style="background-image: linear-gradient(45deg, #0F2027, #2C5364);">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2><?php echo LANG_VALUE_18; ?></h2>
          </div>
        </div>
      </div>
    </div>
			...
			<div class="col-md-12">
                ...
                <div class="cart-buttons">
                    <ul>
                        ...
                        <li><a href="index.php" class="btn btn-primary"><?php echo "Continue to Shopping"; ?></a></li>
