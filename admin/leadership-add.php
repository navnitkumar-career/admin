...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		$statement = $pdo->prepare("SHOW TABLE STATUS LIKE 'tbl_leadership'");
		$statement->execute();
		...
		$final_name = 'leadership-'.$ai_id.'.'.$ext;
        move_uploaded_file( $path_tmp, '../assets/uploads/'.$final_name );

	
		$statement = $pdo->prepare("INSERT INTO tbl_leadership (title,position,content,photo) VALUES (?,?,?,?)");
		$statement->execute(array($_POST['title'],$_POST['position'],$_POST['content'],$final_name));
			
		$success_message = 'Leadership\'s person is added successfully!';
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="position" value="<?php if(isset($_POST['position'])){echo $_POST['position'];} ?>">
							</div>
						</div>
						<div class="form-group">
